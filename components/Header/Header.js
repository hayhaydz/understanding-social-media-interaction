    ...
    return (
        <header>
            <div className="flex justify-between mb-4 md:m-32 flex-col lg:flex-row sm:max-w-xl lg:max-w-full">
                ...
                <div>
                    <a href="https://forms.gle/moPz5c9aGucYjkas9" target="_blank" className="bg-primary flex items-center py-4 px-8 rounded-full no-underline tracking-wider transition-colors hover:bg-primary-700">PROVIDE FEEDBACK <ExternalLink size={14} className="ml-4"/></a>
                </div>
            </div>
