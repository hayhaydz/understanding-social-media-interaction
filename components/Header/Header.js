        ...
        <header>
            <div className="flex justify-between mb-4 md:m-32 flex-col lg:flex-row sm:max-w-xl lg:max-w-full">
                <div className="max-w-full sm:max-w-xl mb-16 md:mb-0">
                    ...
                    <p className="font-Inter text-sm text-gray-300 leading-8 mb-4">{`The way that we interact with social media today is poorly thought out and not tailored to how we interact in real life. The purpose of this research is to explore the different ways that we currently interact and look at new ways to improve how we interact and how it is received.`}</p>
                    <p className="font-Inter font-medium text-sm text-gray-300 leading-normal">{`Please have a look through the interaction examples below and then click the "Provide Feedback" button to fill out a questionnaire.`}</p>
                </div>
                <div>
