        ...
        <header>
            <div className="flex justify-between mb-4 md:m-32 flex-col lg:flex-row sm:max-w-xl lg:max-w-full">
                <div className="max-w-full sm:max-w-xl mb-16 md:mb-0">
                    ...
                    <p className="font-Inter font-bold text-sm text-gray-300 leading-normal">{`Please have a look through the interaction examples below and then click the "Provide Feedback" button to fill out a questionnaire.`}</p>
                </div>
                <div>
